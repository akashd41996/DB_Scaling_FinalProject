...
queries = [
    ...
    # Query 9
    "WITH FilteredOrigin AS (SELECT Hvfhs_license_num, Pickup_datetime, PULocationID FROM `dba-final-project-gcp.without_vm_upload.HV_Freq_Table` WHERE Pickup_datetime BETWEEN TIMESTAMP '2023-01-01 00:00:00' AND TIMESTAMP '2023-01-31 23:59:59'), FilteredDestination AS (SELECT Hvfhs_license_num, DropOff_datetime, DOLocationID FROM `dba-final-project-gcp.without_vm_upload.HV_Freq_Table` WHERE DropOff_datetime BETWEEN TIMESTAMP '2023-01-01 00:00:00' AND TIMESTAMP '2023-01-31 23:59:59') SELECT a.Hvfhs_license_num, a.Pickup_datetime, b.DropOff_datetime FROM FilteredOrigin a JOIN FilteredDestination b ON a.Hvfhs_license_num = b.Hvfhs_license_num WHERE a.PULocationID != b.DOLocationID",
    # Query 10
